    ...
    <div className="space-y-6">
      ...
      {isAdding && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-3xl border border-gray-100 dark:border-gray-800 transform p-6 transition-all max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="lg:col-span-3 flex justify-end gap-3 mt-4 pt-4 border-t border-gray-100 dark:border-gray-800">
